...
export class StateManager {
    ...
    private fallbackOverlayInventory(): OverlayInventory {
        ...
        return {
            content_patches: scan(at('Aavikko.Content', 'Patches'), ['.patch']),
            content_mods: scan(at('Aavikko.Content', 'Mods'), ['.cs', '.xaml']),
            robust_patches: scan(at('Aavikko.RobustToolbox', 'Patches'), ['.patch']),
            robust_mods: scan(at('Aavikko.RobustToolbox', 'Mods'), ['.cs', '.xaml']),
            resource_patches: scan(at('Aavikko.Resources', 'Patches'), null),
            resource_mods: scan(at('Aavikko.Resources', 'Mods'), null),
        };
    }
