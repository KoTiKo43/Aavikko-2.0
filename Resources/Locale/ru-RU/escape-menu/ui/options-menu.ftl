...
ui-options-header-item-offer = Передача предмета # Aavikko item offer
ui-options-function-toggle-item-offer = Переключить режим передачи предмета # Aavikko item offer
