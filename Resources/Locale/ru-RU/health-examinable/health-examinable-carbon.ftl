...
health-examinable-carbon-Asphyxiation-8 = [color=#7DBACE]{ CAPITALIZE(POSS-ADJ($target)) } дыхание слегка затруднено.[/color]  # Aavikko
health-examinable-carbon-Asphyxiation-15 = [color=#7DBACE]{ CAPITALIZE(POSS-ADJ($target)) } дыхание учащённое и поверхностное.[/color]  # Aavikko
health-examinable-carbon-Asphyxiation-30 = [color=lightblue]{ CAPITALIZE(POSS-ADJ($target)) } губы синеют.[/color]
health-examinable-carbon-Asphyxiation-50 = [color=#189FCC]{ CAPITALIZE(POSS-ADJ($target)) } губы заметно посинели.[/color]  # Aavikko
health-examinable-carbon-Asphyxiation-75 = [color=lightblue]{ CAPITALIZE(POSS-ADJ($target)) } лицо синеет.[/color]
health-examinable-carbon-Asphyxiation-100 = [color=#189FCC]{ CAPITALIZE(POSS-ADJ($target)) } лицо сильно посинело от нехватки воздуха.[/color]  # Aavikko
health-examinable-carbon-Asphyxiation-200 = [color=#0E5E80]{ CAPITALIZE(POSS-ADJ($target)) } тело полностью посинело и выглядит неживым![/color]  # Aavikko
